...
describe("[Challenge] Naive receiver", function () {
  ...
  it("Exploit", async function () {
    ...
    /**
     * solution:
     * 因為 NaiveReceiverLenderPool 的 flashLoan function 沒有限制只有 receiver 可以呼叫，所以任何都可以呼叫，而手續費都是由 FlashLoanReceiver 支付，借一次錢的手續費是 1 ETH，我們只要呼叫 flashLoan 10次就可以掏空 FlashLoanReceiver 合約裡的 10 ETH
     */
    for (let i = 0; i < 10; i++) {
